...
object enumSchemaDpi_datasum extends Enumeration {
type enumSchemaDpi_datasum = Value
    ...
    val service_ul_bytes                           = Value(18-1)
    val service_dl_bytes                           = Value(19-1)
    val service_time_seconds                       = Value(20-1)
    val dt                                         = Value(21-1)
    val hour                                       = Value(22-1)
    val loc                                        = Value(23-1)
    val csp                                        = Value(24-1)
