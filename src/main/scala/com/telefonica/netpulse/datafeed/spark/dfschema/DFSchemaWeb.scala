...
object DFSchemaWeb {
  ...
  val dFSchemaWeb = StructType(
    List(
      ...
      StructField("originalsize", LongType, nullable = true),
      StructField("optimisedsize", LongType, nullable = true),
      ...
      StructField("maxbif", IntegerType, nullable = true),
      ...
      StructField("appthroughput", DoubleType, nullable = true),
      StructField("tcpthroughput", DoubleType, nullable = true),
      ...
      StructField("ms", DoubleType, nullable = true),
      StructField("fit", IntegerType, nullable = true),
      ...
      StructField("vslhrzres", IntegerType, nullable = true),
      StructField("vslvertres", IntegerType, nullable = true),
      StructField("vslfrmsze", IntegerType, nullable = true),
      StructField("vslfrmrte", IntegerType, nullable = true),
      StructField("vslmedtm", IntegerType, nullable = true),
      StructField("vslsessinb", IntegerType, nullable = true),
      StructField("vslsessoutb", IntegerType, nullable = true),
      StructField("vslstalldur", IntegerType, nullable = true),
      StructField("vslstalltme", IntegerType, nullable = true),
      StructField("vslqtyup", IntegerType, nullable = true),
      StructField("vslqtydwn", IntegerType, nullable = true),
      StructField("vslstltncy", IntegerType, nullable = true),
      StructField("vslsapreqb", IntegerType, nullable = true),
      StructField("vslsaprspb", IntegerType, nullable = true),
      StructField("vslpcrte", IntegerType, nullable = true),
      StructField("urlfcid", IntegerType, nullable = true),
      StructField("urlfcgid", IntegerType, nullable = true),
      StructField("urlfcrep", IntegerType, nullable = true),
      StructField("urlfrspa", IntegerType, nullable = true),
      StructField("urlfstmtc", IntegerType, nullable = true),
      StructField("urlfstprv", IntegerType, nullable = true),
      StructField("nsobspid", IntegerType, nullable = true),
      StructField("nsobsdid", IntegerType, nullable = true),
      StructField("nsexppid", IntegerType, nullable = true),
      StructField("nstrid", IntegerType, nullable = true),
