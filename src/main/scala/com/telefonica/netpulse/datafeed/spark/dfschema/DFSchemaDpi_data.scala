...
object DFSchemaDpi_data {

  val dFSchemaDpi_data = StructType(
    List(
      ...
      StructField("protocol_category", StringType, nullable = true),
      StructField("service_identifier", StringType, nullable = true),
